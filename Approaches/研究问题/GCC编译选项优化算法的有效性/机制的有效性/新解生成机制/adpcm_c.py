...
if __name__ == '__main__':
    ...
    c_2 =list(eval(data[2]['automotive_susan_s']))
    c_3 =list(eval(data[2]['consumer_jpeg_c']))
    c_1 = list(eval(data[2]['3mm']))
    c_4 = list(eval(data[2]['heat-3d']))
    c_5 =list(eval(data[2]['telecom_adpcm_c']))

    df11 = {'C1(SRA-BM)': Our_5,
             }
    df21 = {'C1(CBOS)': c_5,
             }
    ...
    plt.xticks([1, 2],
               ['OSOA(adpcm_c)', 'OSOA-c(adpcm_c)'],fontsize=13)
