...
if __name__ == '__main__':
    ...
    for alg_temp_it in range(10):
        ...
        for i in range(25):
            positive_seq = sort_list[i]
            negative_seq = sort_list[i + 25]
        ...
        for pos_num in range(10):
            for neg_num in range(10):
                ...
                # print("***********************************")
                # print("temp_pos_list=",temp_pos_list)
                # print("temp_neg_list=", temp_neg_list)
                #
                # print("***********************************")
                ...
                for i in range(86):
                    #1 and 0
                    if (temp_pos_list[i + 1] >= pos and  temp_neg_list[i+1]<=neg):
                        select_opt[i + 1] = 1
                    # 0 and 1
                    elif(temp_pos_list[i + 1] < pos and  temp_neg_list[i+1] > neg):
                        select_opt[i + 1] = 0
                    # (0 and 0)  or   (1 and 1)
                    elif ((temp_pos_list[i + 1] < pos and  temp_neg_list[i+1] < neg) or (temp_pos_list[i + 1] > pos and  temp_neg_list[i+1]>neg)):
                        for  temp_crc_seq in   crc_seqs:
                            if temp_crc_seq[i] == 1 :
                                select_opt[i + 1] = 1
                                key_p = 1
                                break
